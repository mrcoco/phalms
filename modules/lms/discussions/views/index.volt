<div class="col-md-12 col-sm-12">
    <div class="box">
        ...
        <div class="box-body collapse in">
            {{ content() }}
        <table id="grid-discussions" class="table table-condensed table-hover table-striped">
            <thead>
            <tr>
                <th data-column-id="no" data-type="numeric" data-width="5%" data-sortable="false">no</th>
                <th data-column-id="parrent_id" data-sortable="false">Parrent_id</th>
...
<div id="mydiscussions" class="modal fade modal-wide" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="myForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group" >
	<label>Parrent_id</label>
	<input type="text" class="form-control" name="parrent_id" id="parrent_id" >
	</div>
	<div class="form-group" >
