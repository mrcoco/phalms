<script>
    $(document).ready(function(){
        ...
        }).on("loaded.rs.jquery.bootgrid", function()
        {
            ...
            {
                $.get( "{{ url('gallery/delete/') }}"+ $(this).data("row-id"), function( data ) {
                    myAlert(data);
                    $("#grid-gallery").bootgrid("reload");
                });
        ...
        }).on("loaded.rs.jquery.bootgrid", function()
        {
            ...
            {
                $.get( "{{ url('image/delete/') }}"+ $(this).data("row-id"), function( data ) {
                    myAlert(data);
                    $("#grid-selection").bootgrid("reload");
                });
        ...
        function myForm(status,e) {
            ...
            if(status == 'edit') {
                ...
                $.getJSON("{{ url('image/?id=') }}" + e.data("row-id"), function (data) {
        ...
        function myGallery(status,e) {
            ...
            if(status == 'edit') {
                ...
                $.getJSON("{{ url('gallery/get/?id=') }}" + e.data("row-id"), function (data) {
