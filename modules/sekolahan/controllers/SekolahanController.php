...
use Modules\Sekolahan\Models\Sekolahan;
use \Phalcon\Mvc\Model\Manager;
use \Phalcon\Tag;
use Modules\Frontend\Controllers\ControllerBase;
class SekolahanController extends ControllerBase
{
    public function initialize()
    {
        $this->assets
            ->collection('footer')
            ->setTargetPath("themes/admin/assets/js/combined-sekolahan.js")
            ->setTargetUri("themes/admin/assets/js/combined-sekolahan.js")
            ->join(true)
            ->addJs($this->config->application->modulesDir."sekolahan/views/js/js.js")
    ...
    public function listAction()
    {
        ...
        $qryTotal = Sekolahan::find($arProp);
    ...
    {
        $this->view->disable();
        $data = Sekolahan::findFirst($this->request->getPost('hidden_id'));
         $data->name = $this->request->getPost('name');
    ...
    {
        $data = Sekolahan::findFirst($this->request->getQuery('id'));
        $response = new \Phalcon\Http\Response();
        $response->setContentType('application/json', 'UTF-8');
    ...
    {
        $this->view->disable();
        $data   = Sekolahan::findFirstById($id);
